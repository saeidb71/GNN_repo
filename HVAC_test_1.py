...
ax1.set_title(f'$G \, : \,  S_3 \, \, , \, \, N_g \, : \,  {y_val_all.shape[0]}\, \, , \, \, N_{{\mathrm{{OL}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(N_OL_S3.mean(),2)}\, \, , \, \, N_{{\mathrm{{sub}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(num_clasess_btter_than_best_pred_3_single.mean(),2)}\, \, , \, \, J_{{\mathrm{{sub}}}}^{{\mathrm{{avg}}}}  \, : \,  {np.round(pred_3_best_absolute_val.mean(),3)}$', fontsize=15)
ax1.set_xlabel('$ \mathrm{Case\,\,ID}$', fontsize=20)
...
ax2.plot(pred_3_best_absolute_val, 'd',color='g',markersize=4,markerfacecolor='none',label='$J_{\mathrm{sub}}$')
# Set the color of the right y-axis label and tick labels
ax2.set_ylabel('$J_{\mathrm{sub}}$', fontsize=20, color='g')  # Change 'red' to your desired color
...
ax1.set_title(f'$G \, : \,  S_4 \, \, , \, \, N_g \, : \,  {y_val_all.shape[0]}\, \, , \, \, N_{{\mathrm{{OL}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(N_OL_S4.mean(),2)}\, \, , \, \, N_{{\mathrm{{sub}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(num_clasess_btter_than_best_pred_4_single.mean(),2)}\, \, , \, \, J_{{\mathrm{{sub}}}}^{{\mathrm{{avg}}}}  \, : \,  {np.round(pred_4_best_absolute_val.mean(),3)}$', fontsize=15)
ax1.set_xlabel('$ \mathrm{Case\,\,ID}$', fontsize=20)
ax1.set_ylabel('$N$', fontsize=20)
ax1.tick_params(axis='both', which='major', labelsize=15)
...
ax2 = ax1.twinx()
#ax2.plot(pred_3_best_rel_val, 'd',color='g',markersize=4,markerfacecolor='none',label=r'$t_{\hat{g}}/t_g$')
ax2.plot(pred_4_best_absolute_val, 'd',color='g',markersize=4,markerfacecolor='none',label='$J_{\mathrm{sub}}$')
# Set the color of the right y-axis label and tick labels
#ax2.set_ylabel(r'$t_{\hat{g}}/t_g$', fontsize=20, color='g')  # Change 'red' to your desired color
ax2.set_ylabel('$J_{\mathrm{sub}}$', fontsize=20, color='g') 
for label in ax2.get_yticklabels():
    label.set_color('g')  # Change 'red' to your desired color
ax2.tick_params(axis='both', which='major', labelsize=15)
ax2.set_ylim(0.85, 1.03)
...
ax1.set_title(f'$G \, : \,  S_5 \, \, , \, \, N_g \, : \,  {y_val_all.shape[0]}\, \, , \, \, N_{{\mathrm{{OL}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(N_OL_S5.mean(),2)}\, \, , \, \, N_{{\mathrm{{sub}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(num_clasess_btter_than_best_pred_5_single.mean(),2)}\, \, , \, \, J_{{\mathrm{{sub}}}}^{{\mathrm{{avg}}}}  \, : \,  {np.round(pred_5_best_absolute_val.mean(),3)}$', fontsize=15)
ax1.set_xlabel('$ \mathrm{Case\,\,ID}$', fontsize=20)
ax1.set_ylabel('$N$', fontsize=20)
ax1.tick_params(axis='both', which='major', labelsize=15)
...
ax2 = ax1.twinx()
#ax2.plot(pred_3_best_rel_val, 'd',color='g',markersize=4,markerfacecolor='none',label=r'$t_{\hat{g}}/t_g$')
ax2.plot(pred_5_best_absolute_val, 'd',color='g',markersize=4,markerfacecolor='none',label='$J_{\mathrm{sub}}$')
# Set the color of the right y-axis label and tick labels
#ax2.set_ylabel(r'$t_{\hat{g}}/t_g$', fontsize=20, color='g')  # Change 'red' to your desired color
ax2.set_ylabel('$J_{\mathrm{sub}}$', fontsize=20, color='g')
for label in ax2.get_yticklabels():
    label.set_color('g')  # Change 'red' to your desired color
ax2.tick_params(axis='both', which='major', labelsize=15)
ax2.set_ylim(0.95, 1.01) # was 0.90
# Get the handles and labels for both legends
handles1, labels1 = ax1.get_legend_handles_labels()
handles2, labels2 = ax2.get_legend_handles_labels()
# Combine the legends into a single legend
...
ax1.set_title(f'$G \, : \,  M_3 \, \, , \, \, N_g \, : \,  {y_val_all.shape[0]}\, \, , \, \, N_{{\mathrm{{OL}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(N_OL_M3.mean(),2)}\, \, , \, \, N_{{\mathrm{{sub}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(num_clasess_btter_than_best_pred_3_multi.mean(),2)}\, \, , \, \, J_{{\mathrm{{sub}}}} \, : \,  {np.round(t_pred_3_multi_gropuped_best_absolute_val.mean(),3)}$', fontsize=15)
ax1.set_xlabel('$ \mathrm{Case\,\,ID}$', fontsize=20)
ax1.set_ylabel('$N$', fontsize=20)
ax1.tick_params(axis='both', which='major', labelsize=15)
...
ax2 = ax1.twinx()
#ax2.plot(pred_3_best_rel_val, 'd',color='g',markersize=4,markerfacecolor='none',label=r'$t_{\hat{g}}/t_g$')
ax2.plot(t_pred_3_multi_gropuped_best_absolute_val, 'd',color='g',markersize=4,markerfacecolor='none',label='$J_{\mathrm{sub}}$')
# Set the color of the right y-axis label and tick labels
ax2.set_ylabel('$J_{\mathrm{sub}}$', fontsize=20, color='g')
for label in ax2.get_yticklabels():
    label.set_color('g')  # Change 'red' to your desired color
...
ax1.set_title(f'$G \, : \,  M_5 \, \, , \, \, N_g \, : \,  {y_val_all.shape[0]}\, \, , \, \, N_{{\mathrm{{OL}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(N_OL_M4.mean(),2)}\, \, , \, \, N_{{\mathrm{{sub}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(num_clasess_btter_than_best_pred_4_multi.mean(),2)}\, \, , \, \, J_{{\mathrm{{sub}}}}^{{\mathrm{{avg}}}} \, : \,  {np.round(t_pred_4_multi_gropuped_best_absolute_val.mean(),3)}$', fontsize=15)
ax1.set_xlabel('$ \mathrm{Case\,\,ID}$', fontsize=20)
ax1.set_ylabel('$N$', fontsize=20)
ax1.tick_params(axis='both', which='major', labelsize=15)
...
ax2 = ax1.twinx()
#ax2.plot(pred_3_best_rel_val, 'd',color='g',markersize=4,markerfacecolor='none',label=r'$t_{\hat{g}}/t_g$')
ax2.plot(t_pred_4_multi_gropuped_best_absolute_val, 'd',color='g',markersize=4,markerfacecolor='none',label='$J_{\mathrm{sub}}$')
# Set the color of the right y-axis label and tick labels
ax2.set_ylabel('$J_{\mathrm{sub}}$', fontsize=20, color='g')
for label in ax2.get_yticklabels():
    label.set_color('g')  # Change 'red' to your desired color
